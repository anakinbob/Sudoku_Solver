...
public class Sudoku {
    ...
    private Set<Integer> extractRow(int rowNum) {
        ...
        //IntStream intStream = Arrays.stream(_puzzle[rowNum]).boxed().collect(Collectors.toSet());
        //List<Integer> a = Arrays.asList(_puzzle[1]);
        return null;
    }

    private Set<Integer> extractBox(int box) {
        return null;
    }

    private Set<Integer> extractColumn(int column) {
        return null;
    }
